...
public class PBNRecommenderFixture {
	...
	public static Query createQuery() {
		...
		q.setType(VmTypeName.get("LC"));
		q.setClassContext(VmTypeName.get("LC1"));
		q.setMethodContext(VmMethodName.get("LC1.m1()V"));
	...
	public static Query createQueryWithUnobservedData() {
		...
		q.setType(VmTypeName.get("LC"));
		q.setClassContext(VmTypeName.get("LUnobservedClass"));
		q.setMethodContext(VmMethodName.get("LUnobservedClass.someMethod()V"));
		q.setDefinition(DefinitionSites.createDefinitionByConstructor(VmMethodName.get("LC.<init>(LUnobservedInit;)V")));
	...
	public static Tuple<IMethodName, Double> createTuple(String method, double probability) {
		IMethodName methodName = VmMethodName.get(method);
