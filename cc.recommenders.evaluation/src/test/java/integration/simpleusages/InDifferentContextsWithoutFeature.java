...
public class InDifferentContextsWithoutFeature extends AbstractIntegrationTest {
	...
	public Boxplot getExpectation() {
		return new Boxplot(1, 0.6666667, 0.6666667, 0.6666667, 0.6666667, 0.6666667, 0.6666667);
	}
	...
	private static Usage createUsageWithB() {
		...
		usage.setMethodContext(newMethod("Lmy/Container.doitB()V"));
